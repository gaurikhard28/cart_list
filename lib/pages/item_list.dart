...
<<<<<<< HEAD
=======
import 'package:cart_list/strings.dart' as string;
...
=======
    Product(images: "assets/pro1.jpg" ,title: 'Product 1', description: "size: 12, price: 300, color: 2",longDes:string.AppStrings.Product1longDes),
    Product(images: "assets/pro2.jpg" ,title: 'Product 2', description: "size: 15, price: 350, color: 1",longDes:string.AppStrings.Product2longDes),
    Product(images: "assets/pro3.jpg" ,title: 'Product 3', description: "size: 13, price: 500, color: 5",longDes:string.AppStrings.Product3longDes),
    Product(images: "assets/pro4.jpg" ,title: 'Product 4', description: "size: 12, price: 700, color: 2",longDes:string.AppStrings.Product4longDes),
    Product(images: "assets/pro1.jpg" ,title: 'Product 5', description: "size: 13, price: 300, color: 1",longDes:string.AppStrings.Product5longDes),];
>>>>>>> 28aec60 (buttons added)
...
=======
  const Product({required this.images, required this.title, required this.description, required this.longDes,});
  final String title;
  final String images;
  final String description;
